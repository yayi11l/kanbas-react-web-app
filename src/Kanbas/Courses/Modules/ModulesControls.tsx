...
export default function ModulesControls() {
  return (
    <div id="wd-modules-controls" className="text-nowrap">
      ...
      <button id="wd-modules-btn" value="View Progress" className="btn btn-lg btn-secondary me-1 float-end">
        View Progress
      </button>
      <button id="wd-modules-btn" className="btn btn-lg btn-secondary me-1 float-end">
      Collapse All
      </button>
